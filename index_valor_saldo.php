        ...
        <div class="container" style="max-width: 1650px;">
            ...
            <table class="table" style="margin-top: 50px;border-radius:15px; border: 2px solid #f3f3f3;" >
                ...
                <tbody >
                    ...
                    $sql = "SELECT empenho.credor as credor, empenho.natureza as natureza, empenho.valor_empenho as valor, empenho.saldo_empenho as saldo, (empenho.valor_empenho - empenho.saldo_empenho) as diferenca, empenho.ano as ano FROM `empenho` as empenho
                            HAVING valor > saldo
                            LIMIT 50";
