...
<?php
    ...
    $stmt = $dbcon -> prepare("SELECT  SUM(gastosporunidade.valor) as valor ,processo.ano as anoprocesso, naturezadespesa.natureza as natureza, unidade.nome_unidade as unidade
