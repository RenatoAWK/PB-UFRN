...
$stmt = $dbcon -> prepare("SELECT empenho.credor as credor, SUM(empenho.valor_empenho) as valor, empenho.natureza as natureza, empenho.ano as ano FROM `empenho` as empenho
                            GROUP BY $eixoX
                            ORDER BY valor DESC, $eixoY $ordenacao
                            LIMIT 7");
$stmt -> execute();
$json = [];
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="container" style="margin-top: 15px;">
        ...
        <div class="filtros">
            ...
            <form action="grafico_case_4.php" method="post" style="display:flex; margin-left: 300px">
        ...
        <div class="grafico"style="margin-top:15px;">
            ...
            <script>
                ...
                data: {
                    labels:  <?php  echo json_encode($naturezaList);?>,
