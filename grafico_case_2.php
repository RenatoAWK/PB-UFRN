...
$stmt = $dbcon -> prepare("SELECT tipoprocesso.tipo as tipo, processo.assunto as assunto, processo.ano as ano, COUNT(tipo) as quantidade
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="container" style="margin-top: 15px;">
        ...
        <div class="filtros">
            ...
            <form action="grafico_case_2.php" method="post" style="display:flex; margin-left: 300px">
            ...
            <div class="form-group" style="margin-left:50px">
                ...
                <select class="form-control text"  name="eixoY" >
                    <option value="valor">quantidade</option>
